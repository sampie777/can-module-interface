...
import nl.sajansen.canmoduleinterface.utils.gui.DefaultDialogKeyDispatcher
...
class InfoFrame(private val parentFrame: JFrame?) : JDialog(parentFrame) {
    ...
    private fun createGui() {
        ...
        val applicationLoggingInfoLabel = JLabel(
            "<html>Application log file location: ${
                Paths.get(
                    System.getProperty("java.io.tmpdir"),
                    "${ApplicationInfo.artifactId}.log"
                )
            }</html>"
        )
